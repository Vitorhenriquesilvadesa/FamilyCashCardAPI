...
class CashCardApplicationTests {
    ...
    void shouldReturnAPageOfCashCards() {
        ...
        ResponseEntity<String> response = restTemplate
                .withBasicAuth("User1", "abc123")
                .getForEntity("/cash_cards?page=0&size=1", String.class);
    ...
    void shouldNotReturnACashCardWhenUsingBadCredentials() {
        ...
        response = restTemplate
                .withBasicAuth("User1", "BAD-PASSWORD")
                .getForEntity("/cash_cards/99", String.class);
        assertThat(response.getStatusCode()).isEqualTo(HttpStatus.UNAUTHORIZED);
    }
    ...
    void shouldNotAllowAccessToCashCardsTheyDoNotOwn() {
        ResponseEntity<String> response = restTemplate
                .withBasicAuth("User1", "abc123")
                .getForEntity("/cash_cards/102", String.class);
    ...
    void shouldUpdateAnExistingCashCard() {
        CashCard cashCardUpdate = new CashCard(null, 123.45, null);
